"""Throwaway fixture module (19/20) -- not real code, see ../README.md.
...
def normalize_sorter_utils(value):
...
def chunk_sorter_utils(items, size):
...
def summarize_sorter_utils(numbers):
...
class SorterUtilsHelper:
    ...
    def __init__(self, label="sorter_utils"):
        self.label = label
        self._history = []
