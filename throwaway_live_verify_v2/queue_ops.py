"""Throwaway fixture module (12/20) -- not real code, see ../README.md.
...
def chunk_queue_ops(items, size):
...
def summarize_queue_ops(numbers):
...
class QueueOpsHelper:
    ...
    def __init__(self, label="queue_ops"):
        self.label = label
        self._history = []
