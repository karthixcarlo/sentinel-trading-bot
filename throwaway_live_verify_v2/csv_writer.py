"""Throwaway fixture module (8/20) -- not real code, see ../README.md.
...
def normalize_csv_writer(value):
...
def chunk_csv_writer(items, size):
...
def summarize_csv_writer(numbers):
...
class CsvWriterHelper:
    ...
    def __init__(self, label="csv_writer"):
        self.label = label
        self._history = []
