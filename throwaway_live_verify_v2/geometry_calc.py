"""Throwaway fixture module (17/20) -- not real code, see ../README.md.
...
def normalize_geometry_calc(value):
...
def chunk_geometry_calc(items, size):
...
def summarize_geometry_calc(numbers):
...
class GeometryCalcHelper:
    ...
    def __init__(self, label="geometry_calc"):
        self.label = label
        self._history = []
