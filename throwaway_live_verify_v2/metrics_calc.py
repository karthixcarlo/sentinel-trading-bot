"""Throwaway fixture module (15/20) -- not real code, see ../README.md.
...
def normalize_metrics_calc(value):
...
def chunk_metrics_calc(items, size):
...
def summarize_metrics_calc(numbers):
...
class MetricsCalcHelper:
    ...
    def __init__(self, label="metrics_calc"):
        self.label = label
        self._history = []
