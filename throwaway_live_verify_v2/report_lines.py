"""Throwaway fixture module (6/20) -- not real code, see ../README.md.
...
def normalize_report_lines(value):
...
def chunk_report_lines(items, size):
...
def summarize_report_lines(numbers):
...
class ReportLinesHelper:
    ...
    def __init__(self, label="report_lines"):
        self.label = label
        self._history = []
