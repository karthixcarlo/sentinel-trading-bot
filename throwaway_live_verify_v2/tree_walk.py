"""Throwaway fixture module (20/20) -- not real code, see ../README.md.
...
def chunk_tree_walk(items, size):
...
def summarize_tree_walk(numbers):
...
class TreeWalkHelper:
    ...
    def __init__(self, label="tree_walk"):
        self.label = label
        self._history = []
