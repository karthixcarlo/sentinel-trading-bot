"""Throwaway fixture module (5/20) -- not real code, see ../README.md.
...
def normalize_string_builder(value):
...
def chunk_string_builder(items, size):
...
def summarize_string_builder(numbers):
...
class StringBuilderHelper:
    ...
    def __init__(self, label="string_builder"):
        self.label = label
        self._history = []
