"""Throwaway fixture module (1/20) -- not real code, see ../README.md.
...
def normalize_text_formatting(value):
...
def chunk_text_formatting(items, size):
...
def summarize_text_formatting(numbers):
...
class TextFormattingHelper:
    ...
    def __init__(self, label="text_formatting"):
        self.label = label
        self._history = []
