"""Throwaway fixture module (11/20) -- not real code, see ../README.md.
...
def normalize_cache_lite(value):
...
def chunk_cache_lite(items, size):
...
def summarize_cache_lite(numbers):
...
class CacheLiteHelper:
    ...
    def __init__(self, label="cache_lite"):
        self.label = label
        self._history = []
