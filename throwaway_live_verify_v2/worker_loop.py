"""Throwaway fixture module (13/20) -- not real code, see ../README.md.
...
def normalize_worker_loop(value):
...
def chunk_worker_loop(items, size):
...
def summarize_worker_loop(numbers):
...
class WorkerLoopHelper:
    ...
    def __init__(self, label="worker_loop"):
        self.label = label
        self._history = []
