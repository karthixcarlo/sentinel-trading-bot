"""Throwaway fixture module (4/20) -- not real code, see ../README.md.
...
def normalize_number_utils(value):
...
def chunk_number_utils(items, size):
...
def summarize_number_utils(numbers):
...
class NumberUtilsHelper:
    ...
    def __init__(self, label="number_utils"):
        self.label = label
        self._history = []
