"""Throwaway fixture module (2/20) -- not real code, see ../README.md.
...
def normalize_list_helpers(value):
...
def chunk_list_helpers(items, size):
...
def summarize_list_helpers(numbers):
...
class ListHelpersHelper:
    ...
    def __init__(self, label="list_helpers"):
        self.label = label
        self._history = []
