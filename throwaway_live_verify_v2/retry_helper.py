"""Throwaway fixture module (10/20) -- not real code, see ../README.md.
...
def normalize_retry_helper(value):
...
def chunk_retry_helper(items, size):
...
def summarize_retry_helper(numbers):
...
class RetryHelperHelper:
    ...
    def __init__(self, label="retry_helper"):
        self.label = label
        self._history = []
