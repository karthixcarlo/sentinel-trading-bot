"""Throwaway fixture module (9/20) -- not real code, see ../README.md.
...
def normalize_json_shape(value):
...
def chunk_json_shape(items, size):
...
def summarize_json_shape(numbers):
...
class JsonShapeHelper:
    ...
    def __init__(self, label="json_shape"):
        self.label = label
        self._history = []
