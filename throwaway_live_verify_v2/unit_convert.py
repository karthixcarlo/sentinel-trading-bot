"""Throwaway fixture module (18/20) -- not real code, see ../README.md.
...
def normalize_unit_convert(value):
...
def chunk_unit_convert(items, size):
...
def summarize_unit_convert(numbers):
...
class UnitConvertHelper:
    ...
    def __init__(self, label="unit_convert"):
        self.label = label
        self._history = []
