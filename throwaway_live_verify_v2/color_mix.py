"""Throwaway fixture module (16/20) -- not real code, see ../README.md.
...
def chunk_color_mix(items, size):
...
def summarize_color_mix(numbers):
...
class ColorMixHelper:
    ...
    def __init__(self, label="color_mix"):
        self.label = label
        self._history = []
