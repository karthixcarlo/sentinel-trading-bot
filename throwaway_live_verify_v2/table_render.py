"""Throwaway fixture module (7/20) -- not real code, see ../README.md.
...
def normalize_table_render(value):
...
def chunk_table_render(items, size):
...
def summarize_table_render(numbers):
...
class TableRenderHelper:
    ...
    def __init__(self, label="table_render"):
        self.label = label
        self._history = []
