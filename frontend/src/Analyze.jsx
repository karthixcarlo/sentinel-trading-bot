    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-groww-light-gray p-6 lg:p-10 font-sans">
                ...
                <div className="max-w-4xl mx-auto bg-white rounded-2xl border border-groww-gray/20 p-8 shadow-sm">
    ...
    return (
        <div className="min-h-screen bg-groww-light-gray p-6 lg:p-10 font-sans">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-2xl border border-groww-gray/20 overflow-hidden shadow-sm">

                    {/* Header Banner */}
                    <div className="p-8 border-b border-groww-gray/10 bg-gradient-to-r from-white to-groww-light-gray/40">
                        <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
                            ...
                            <div className="text-left md:text-right bg-white md:bg-transparent p-4 md:p-0 rounded-xl border md:border-none border-groww-gray/10 shadow-sm md:shadow-none">
                        ...
                        <div className="mt-8 flex flex-wrap gap-4">
                            <div className="flex items-center text-sm font-bold text-groww-dark bg-white border border-groww-gray/10 shadow-sm px-4 py-2.5 rounded-lg">
