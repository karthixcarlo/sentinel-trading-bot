    ...
    return (
        <div className="min-h-screen bg-groww-light-gray p-6 lg:p-10 font-sans text-groww-dark">
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                {portfolio && (
                    <div className="grid grid-cols-3 gap-4">
                        {[
                            ...
                            <div key={m.label} className="bg-dark-card rounded-xl border border-groww-gray/10 p-4 shadow-sm text-center">
                ...
                {/* Trade Form */}
                <form onSubmit={handleSubmit} className="bg-dark-card rounded-2xl border border-groww-gray/10 shadow-sm p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select value={orderType} onChange={e => setOrderType(e.target.value)}
                                    className="w-full px-4 py-3.5 border border-groww-gray/20 rounded-xl font-bold text-groww-dark appearance-none focus:outline-none focus:border-groww-green focus:ring-2 focus:ring-groww-green/20 transition-all bg-dark-card">
